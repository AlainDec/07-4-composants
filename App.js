...
export default function App() {
  ...
  const ratio = win.height * 0.5 / imageHeight;
  const widthImg = imageWidth * ratio;
  const heightImg = win.height * 0.5;

  return (
    <View style={styles.container}>
        <Image source={require('./assets/rover.jpg')} style={[styles.img, {width: widthImg, height: heightImg}]} />
